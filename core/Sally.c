...
static uint8_t sally_MemoryRead(uint16_t address)
{
...
static void sally_MemoryWrite(uint16_t address, uint8_t data)
{
   sally_slowcycles += (address >= 0x000 && address <= 0x01F) ? 1 : 0;  /* TIA */
   sally_slowcycles += (address >= 0x280 && address <= 0x2FF) ? 1 : 0;  /* RIOT */
...
{
   sally_MemoryWrite(sally_s + 256, data);
   sally_s--;
}
...
{
   sally_s++;
   return sally_MemoryRead(sally_s + 256);
}
...
{
   sally_address.b.l = sally_MemoryRead(sally_pc.w++);
   sally_address.b.h = sally_MemoryRead(sally_pc.w++);
}
...
{
   pair base;
   base.b.l = sally_MemoryRead(sally_pc.w++);
   base.b.h = sally_MemoryRead(sally_pc.w++);
   sally_address.b.l = sally_MemoryRead(base.w);
   sally_address.b.h = sally_MemoryRead(base.w + 1);
}

static void sally_IndirectX(void)
{
   sally_address.b.l = sally_MemoryRead(sally_pc.w++) + sally_x;
   sally_address.b.h = sally_MemoryRead(sally_address.b.l + 1);
   sally_address.b.l = sally_MemoryRead(sally_address.b.l);
}
...
{
   sally_address.w = sally_MemoryRead(sally_pc.w++);
}
...
{
   uint8_t data = sally_MemoryRead(sally_address.w);
...
{
   sally_a &= sally_MemoryRead(sally_address.w);
   sally_Flags(sally_a);
}
...
static void sally_ASL(void)
{
   ...
   data <<= 1;
   sally_MemoryWrite(sally_address.w, data);
   sally_Flags(data);
}
...
{
   sally_x = sally_MemoryRead(sally_address.w);
   sally_Flags(sally_x);
}

static void sally_LDY(void)
{
   sally_y = sally_MemoryRead(sally_address.w);
   sally_Flags(sally_y);
}
...
{
   sally_MemoryWrite(sally_address.w, sally_a);
}

static void sally_STX(void)
{
   sally_MemoryWrite(sally_address.w, sally_x);
}

static void sally_STY(void)
{
   sally_MemoryWrite(sally_address.w, sally_y);
}
...
{
   sally_opcode = sally_MemoryRead(sally_pc.w++);
