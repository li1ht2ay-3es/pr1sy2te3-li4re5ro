...
static const uint8_t PALETTE_NTSC[ ] =
{
...
static const uint8_t PALETTE_PAL[ ] =
{
...
void palette_Preset(int preset)
{
   int index;
   const uint8_t *palette[] =
   {
      PALETTE_NTSC, PALETTE_PAL,  /* ProSystem */
   };

   for (index = 0; index < PALETTE_SIZE; index++)
      palette_data[index] = palette[preset][index];
}
